...
require (
	...
	k8s.io/autoscaler/cluster-autoscaler v0.0.0-20220902140806-e8d3e9b1d986
...
require (
	...
	github.com/Azure/skewer v0.0.14 // indirect
	...
	sigs.k8s.io/cloud-provider-azure v1.24.2 // indirect
...
replace (
	...
	k8s.io/mount-utils => k8s.io/mount-utils v0.25.1-rc.0
